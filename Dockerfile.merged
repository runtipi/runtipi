...
COPY --from=dashboard_builder /dash/next.config.mjs ./
COPY --from=dashboard_builder /dash/public ./public
COPY --from=dashboard_builder /dash/package.json ./package.json
COPY --from=dashboard_builder /dash/.next/standalone ./
COPY --from=dashboard_builder /dash/.next/static ./.next/static
