...
export const SettingsForm = (props: IProps) => {
  ...
  const validateFields = (values: SettingsFormValues) => {
    ...
    if (
      values.internalIp &&
      values.internalIp !== "localhost" &&
      !validator.isIP(values.internalIp)
    ) {
  ...
  const downloadCertificate = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    window.open("/worker-api/system/certificate");
  };
    ...
    <>
      <div className="d-flex">
        ...
        <h2 className="text-2xl font-bold">
          {t("SETTINGS_GENERAL_USER_SETTINGS")}
        </h2>
      </div>
      ...
      <form className="flex flex-col mt-2" onSubmit={handleSubmit(validate)}>
              ...
              <Switch
                ...
                label={
                  <>
                    ...
                    <Tooltip
                      className="tooltip"
                      anchorSelect=".guest-dashboard-hint"
                    >
                      {t("SETTINGS_GENERAL_GUEST_DASHBOARD_HINT")}
                    </Tooltip>
                    <span
                      className={clsx("ms-1 form-help guest-dashboard-hint")}
                    >
                      ?
                    </span>
                  </>
              ...
              <Switch
                ...
                label={
                  <>
                    ...
                    <Tooltip
                      className="tooltip"
                      anchorSelect=".allow-errors-hint"
                    >
                      {t("SETTINGS_GENERAL_ALLOW_ERROR_MONITORING_HINT")}
                    </Tooltip>
                    <span className={clsx("ms-1 form-help allow-errors-hint")}>
                      ?
                    </span>
                  </>
                }
              ...
              <Switch
                ...
                label={
                  <>
                    ...
                    <Tooltip
                      className="tooltip"
                      anchorSelect=".allow-auto-themes-hint"
                    >
                      {t("SETTINGS_GENERAL_ALLOW_AUTO_THEMES_HINT")}
                    </Tooltip>
                    <span
                      className={clsx("ms-1 form-help allow-auto-themes-hint")}
                    >
                      ?
                    </span>
                  </>
          ...
          <Input
            ...
            label={
              <>
                ...
                <span className={clsx("ms-1 form-help domain-name-hint")}>
                  ?
                </span>
              </>
            }
        ...
        <div className="mb-3">
          <Input
            {...register("dnsIp")}
            label={t("SETTINGS_GENERAL_DNS_IP")}
            error={errors.dnsIp?.message}
            placeholder="9.9.9.9"
          />
        </div>
        <div className="mb-3">
          <Input
            ...
            label={
              <>
                ...
                <span className={clsx("ms-1 form-help internal-ip-hint")}>
                  ?
                </span>
              </>
            }
          ...
          <Input
            ...
            label={
              <>
                ...
                <span className={clsx("ms-1 form-help storage-path-hint")}>
                  ?
                </span>
              </>
            }
          ...
          <Input
            ...
            label={
              <>
                ...
                <span className={clsx("ms-1 form-help local-domain-hint")}>
                  ?
                </span>
              </>
            }
