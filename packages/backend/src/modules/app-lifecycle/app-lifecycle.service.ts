...
export class AppLifecycleService {
   ...
   */
  public async uninstallApp(params: { appId: string; deleteBackups: boolean }) {
    const { appId, deleteBackups } = params;
    ...
    if (deleteBackups) {
      await this.backupManager.deleteBackupsByAppId(appId);
    }
