...
export type RestartAppParams = {
  skipPull?: boolean;
};

@Injectable()
export class RestartAppHandler implements ILifecycleHandler<RestartAppParams> {
  constructor(
  ...
  async execute(appUrn: AppUrn, params?: RestartAppParams): Promise<HandlerResult> {
