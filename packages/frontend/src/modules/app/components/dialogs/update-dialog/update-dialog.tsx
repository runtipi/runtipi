        ...
        <DialogContent size={SIZE_MAP[currentStep]}>
          ...
          <DialogDescription>
            <Stepper currentStep={currentStep}>
              <StepTriggerList>
                <StepTrigger step={0} title="Information" onStepChange={setCurrentStep} />
                <StepTrigger step={1} title="Configuration" onStepChange={setCurrentStep} />
                <StepTrigger step={2} title="Compose" onStepChange={setCurrentStep} />
                <StepTrigger step={3} title="Backup" onStepChange={setCurrentStep} />
              </StepTriggerList>
              <div className="mt-2">
                <StepContent step={0}>
                  <div className="text-muted">
                    ...
                    <br />
                    Click the button below to have a look at the changes and update.
                  </div>
                </StepContent>
                <StepContent step={1}>
                  <div className="text-muted">Review the changes to the app configuration file.</div>
                  <CodeMirror
                    value={newConfig}
                    readOnly={true}
                    height="400px"
                ...
                <StepContent step={2}>
                  <div className="text-muted">Review the changes to the app compose file.</div>
                  <CodeMirror
                    value={newCompose}
                    readOnly={true}
                    height="400px"
                  ...
                  <Alert variant="info" className="mt-3">
                    ...
                    <div>
                      ...
                      <AlertDescription>If no changes are shown, then the app's compose file has not changed.</AlertDescription>
                    </div>
                  </Alert>
                </StepContent>
                <StepContent step={3}>
                  <div className="text-muted">
                    It is highly recommended to backup the app before updating. You can always restore from a backup if something goes wrong.
                  </div>
