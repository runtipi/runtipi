...
export const BatchActionsButton = ({}: Props) => {
  ...
  return <BatchActionDialog isOpen={dialogDisclosure.isOpen} onClose={dialogDisclosure.close} onConfirm={handleConfirm} action={selectedAction} />;
};
