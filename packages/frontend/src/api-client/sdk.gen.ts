...
export const getAppUpdateDiff = <ThrowOnError extends boolean = false>(options: Options<GetAppUpdateDiffData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetAppUpdateDiffResponses, unknown, ThrowOnError>({
