...
import { type Options, userContext, appContext, updateUserSettings, acknowledgeWelcome, systemLoad, downloadLocalCertificate, getTranslation, login, verifyTotp, register, logout, changeUsername, changePassword, getTotpUri, setupTotp, disableTotp, cancelResetPassword, checkResetPasswordRequest, resetPassword, traefik, getInstalledApps, getGuestApps, getRandomPort, getApp, getAppComposeDiff, getAppConfigDiff, searchApps, getImage, pullAppStores, createAppStore, getAllAppStores, getEnabledAppStores, deleteAppStore, updateAppStore, installApp, startApp, stopApp, restartApp, uninstallApp, resetApp, updateApp, updateAppConfig, updateAllApps, backupApp, restoreAppBackup, deleteAppBackup, getAppBackups, appEvents, appLogsEvents, runtipiLogsEvents, getGuestLinks, getLinks, createLink, deleteLink, editLink, check, getUserConfig, updateUserConfig, enableUserConfig, disableUserConfig, createCustomApp, updateCustomApp, uploadAppImage, updateAppMetadata, seedDatabase, setAllAppUpdateAvailable, setAllAppSubnetToNull, startAllApps, backupAllApps, incrementAllAppVersions, uninstallAllApps } from '../sdk.gen';
