...
import { type Options, userContext, appContext, updateUserSettings, acknowledgeWelcome, systemLoad, downloadLocalCertificate, getTranslation, login, verifyTotp, register, logout, changeUsername, changePassword, getTotpUri, setupTotp, disableTotp, cancelResetPassword, checkResetPasswordRequest, resetPassword, traefik, getInstalledApps, getGuestApps, getRandomPort, getApp, getAppUpdateDiff, searchApps, getImage, pullAppStores, createAppStore, getAllAppStores, getEnabledAppStores, deleteAppStore, updateAppStore, installApp, startApp, stopApp, restartApp, uninstallApp, resetApp, updateApp, updateAppConfig, updateAllApps, backupApp, restoreAppBackup, deleteAppBackup, getAppBackups, appEvents, appLogsEvents, runtipiLogsEvents, getGuestLinks, getLinks, createLink, deleteLink, editLink, check, getUserConfig, updateUserConfig, enableUserConfig, disableUserConfig, createCustomApp, seedDatabase, setAllAppUpdateAvailable, setAllAppSubnetToNull, startAllApps, backupAllApps, incrementAllAppVersions, uninstallAllApps } from '../sdk.gen';
...
import type { UserContextData, AppContextData, UpdateUserSettingsData, AcknowledgeWelcomeData, SystemLoadData, DownloadLocalCertificateData, GetTranslationData, LoginData, LoginResponse, VerifyTotpData, VerifyTotpResponse, RegisterData, RegisterResponse, LogoutData, ChangeUsernameData, ChangePasswordData, GetTotpUriData, GetTotpUriResponse, SetupTotpData, DisableTotpData, CancelResetPasswordData, CheckResetPasswordRequestData, ResetPasswordData, ResetPasswordResponse, TraefikData, GetInstalledAppsData, GetGuestAppsData, GetRandomPortData, GetRandomPortResponse, GetAppData, GetAppUpdateDiffData, SearchAppsData, SearchAppsResponse, GetImageData, PullAppStoresData, PullAppStoresResponse, CreateAppStoreData, CreateAppStoreResponse, GetAllAppStoresData, GetEnabledAppStoresData, DeleteAppStoreData, UpdateAppStoreData, UpdateAppStoreResponse, InstallAppData, InstallAppResponse, StartAppData, StartAppResponse, StopAppData, StopAppResponse, RestartAppData, RestartAppResponse, UninstallAppData, UninstallAppResponse, ResetAppData, ResetAppResponse, UpdateAppData, UpdateAppResponse, UpdateAppConfigData, UpdateAppConfigResponse, UpdateAllAppsData, BackupAppData, BackupAppResponse, RestoreAppBackupData, RestoreAppBackupResponse, DeleteAppBackupData, GetAppBackupsData, GetAppBackupsResponse, AppEventsData, AppLogsEventsData, RuntipiLogsEventsData, GetGuestLinksData, GetLinksData, CreateLinkData, DeleteLinkData, EditLinkData, CheckData, GetUserConfigData, UpdateUserConfigData, EnableUserConfigData, DisableUserConfigData, CreateCustomAppData, CreateCustomAppResponse, SeedDatabaseData, SetAllAppUpdateAvailableData, SetAllAppSubnetToNullData, StartAllAppsData, BackupAllAppsData, IncrementAllAppVersionsData, UninstallAllAppsData } from '../types.gen';
...
export const getAppUpdateDiffQueryKey = (options: Options<GetAppUpdateDiffData>) => createQueryKey('getAppUpdateDiff', options);

export const getAppUpdateDiffOptions = (options: Options<GetAppUpdateDiffData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getAppUpdateDiff({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getAppUpdateDiffQueryKey(options)
    });
};
