...
import { acknowledgeWelcome, appContext, appEvents, appLogsEvents, backupAllApps, backupApp, cancelAppEvent, cancelRepoEvent, cancelResetPassword, changePassword, changeUsername, check, checkResetPasswordRequest, createAppStore, createCustomApp, createLink, deleteAppBackup, deleteAppStore, deleteLink, disableTotp, disableUserConfig, downloadBackup, downloadLocalCertificate, editLink, enableUserConfig, getAllAppStores, getApp, getAppBackups, getAppComposeDiff, getAppConfigDiff, getAppEvents, getEnabledAppStores, getGuestApps, getGuestLinks, getImage, getInstalledApps, getLinks, getRandomPort, getRepoEvents, getTotpUri, getTranslation, getUserConfig, ignoreAppVersion, incrementAllAppVersions, installApp, login, logout, type Options, pullAppStores, register, resetApp, resetPassword, restartApp, restoreAppBackup, runtipiLogsEvents, searchApps, seedDatabase, setAllAppSubnetToNull, setAllAppUpdateAvailable, setupTotp, startAllApps, startApp, stopApp, systemLoad, traefik, unignoreAppVersion, uninstallAllApps, uninstallApp, updateAllApps, updateApp, updateAppConfig, updateAppMetadata, updateAppStore, updateCustomApp, updateUserConfig, updateUserSettings, uploadAppImage, uploadBackup, userContext, verifyTotp } from '../sdk.gen';
import type { AcknowledgeWelcomeData, AppContextData, AppEventsData, AppLogsEventsData, BackupAllAppsData, BackupAppData, BackupAppResponse, CancelAppEventData, CancelRepoEventData, CancelResetPasswordData, ChangePasswordData, ChangeUsernameData, CheckData, CheckResetPasswordRequestData, CreateAppStoreData, CreateAppStoreResponse, CreateCustomAppData, CreateCustomAppResponse, CreateLinkData, DeleteAppBackupData, DeleteAppStoreData, DeleteLinkData, DisableTotpData, DisableUserConfigData, DownloadBackupData, DownloadLocalCertificateData, EditLinkData, EnableUserConfigData, GetAllAppStoresData, GetAppBackupsData, GetAppBackupsResponse, GetAppComposeDiffData, GetAppConfigDiffData, GetAppData, GetAppEventsData, GetEnabledAppStoresData, GetGuestAppsData, GetGuestLinksData, GetImageData, GetInstalledAppsData, GetLinksData, GetRandomPortData, GetRandomPortResponse, GetRepoEventsData, GetTotpUriData, GetTotpUriResponse, GetTranslationData, GetUserConfigData, IgnoreAppVersionData, IncrementAllAppVersionsData, InstallAppData, InstallAppResponse, LoginData, LoginResponse, LogoutData, PullAppStoresData, PullAppStoresResponse, RegisterData, RegisterResponse, ResetAppData, ResetAppResponse, ResetPasswordData, ResetPasswordResponse, RestartAppData, RestartAppResponse, RestoreAppBackupData, RestoreAppBackupResponse, RuntipiLogsEventsData, SearchAppsData, SearchAppsResponse, SeedDatabaseData, SetAllAppSubnetToNullData, SetAllAppUpdateAvailableData, SetupTotpData, StartAllAppsData, StartAppData, StartAppResponse, StopAppData, StopAppResponse, SystemLoadData, TraefikData, UnignoreAppVersionData, UninstallAllAppsData, UninstallAppData, UninstallAppResponse, UpdateAllAppsData, UpdateAppConfigData, UpdateAppConfigResponse, UpdateAppData, UpdateAppMetadataData, UpdateAppResponse, UpdateAppStoreData, UpdateAppStoreResponse, UpdateCustomAppData, UpdateUserConfigData, UpdateUserSettingsData, UploadAppImageData, UploadBackupData, UserContextData, VerifyTotpData, VerifyTotpResponse } from '../types.gen';
...
export const getAppEventsQueryKey = (options?: Options<GetAppEventsData>) => createQueryKey('getAppEvents', options);

export const getAppEventsOptions = (options?: Options<GetAppEventsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getAppEvents({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getAppEventsQueryKey(options)
    });
};

export const getRepoEventsQueryKey = (options?: Options<GetRepoEventsData>) => createQueryKey('getRepoEvents', options);

export const getRepoEventsOptions = (options?: Options<GetRepoEventsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getRepoEvents({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getRepoEventsQueryKey(options)
    });
};

export const cancelAppEventMutation = (options?: Partial<Options<CancelAppEventData>>): UseMutationOptions<unknown, DefaultError, Options<CancelAppEventData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<CancelAppEventData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await cancelAppEvent({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const cancelRepoEventMutation = (options?: Partial<Options<CancelRepoEventData>>): UseMutationOptions<unknown, DefaultError, Options<CancelRepoEventData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<CancelRepoEventData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await cancelRepoEvent({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
