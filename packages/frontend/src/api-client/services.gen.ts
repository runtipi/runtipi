...
export const pullAppStore = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
...
export const getAllAppStores = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
...
export const getEnabledAppStores = <ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) => {
