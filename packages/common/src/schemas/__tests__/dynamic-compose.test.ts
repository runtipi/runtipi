...
import { serviceSchema, dynamicComposeSchema } from '../dynamic-compose.js';
...
const safeParse = safeParseArk;

describe('DynamicCompose Schema Tests', () => {
  ...
  describe('Edge Cases and Error Conditions', () => {
    ...
    it('should handle malformed data structures', () => {
      const testCases = ['string', 123, [], { schemaVersion: '2', services: 'not-array' }, { schemaVersion: 2, services: [{ invalid: 'service' }] }];
