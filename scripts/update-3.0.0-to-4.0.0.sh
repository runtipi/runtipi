...
# Start runtipi
echo -e "\nMigration complete! Updating Runtipi to v4.0.2...\n"
...
URL="https://github.com/runtipi/runtipi/releases/download/v4.0.2/$ASSET"
